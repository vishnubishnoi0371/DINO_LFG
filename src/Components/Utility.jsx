        ...
        <div className=" container mx-auto max-w-[1014px] px-3 py-[70px] md:py-[200px]">
          ...
          <div className="max-w-[1014px] z-30 py-[30px] md:py-[62px] px-[40px] border relative rounded-[20px] border-white bg-[#09655a] mb-[20px] sm:mb-[30px] md:mb-[125px]">
            <div className="flex flex-row items-center justify-center flex-wrap  -mx-3">
              ...
              >
                <p className="text-[25px] sm:text-[32px] sm:leading-[39px] font-bold  font-balsa max-w-[680px] mb-4 sm:mb-[28px] text-white">
                ...
                <p className="text-[25px] sm:text-[32px] sm:leading-[39px] font-bold  font-balsa max-w-[695px] text-white">
              ...
              <div className="w-full xs_1:w-3/12 px-3">
                <img
                  className="absolute opacity-[0.3] md:opacity-[1] bottom-0 right-[2%] md:max-w-[255px] md:max-h-[330px]  max-w-[205px] max-h-[290px] animate-scat"
                  src={utility_gudda_1}
                  alt="gudda"
                />
              </div>
          ...
          <div className="max-w-[1014px] sm:z-30 relative py-[30px] md:py-[95px] ps-[40px] pe-[27px] border rounded-[20px] border-white bg-[#09655a] mb-[100px] lg:mb-[268px]">
            <div className="flex flex-row items-center justify-end flex-wrap  -mx-3">
              <div className="w-full xs_1:w-8/12 px-3">
                <img
                  className="absolute opacity-[0.3] md:opacity-[1]  bottom-0 left-[0%] md:max-w-[265px] md:max-h-[335px] max-w-[135px] max-h-[150px]  animate-cycle"
                  src={utility_gudda_2}
                  alt="gudda"
                />
              </div>
              <div className="w-full xs_1:w-8/12 px-3">
                ...
                >
                  <p className="text-[25px] sm:text-[32px] z-10 md:leading-[39px] font-bold text-start md:text-end  font-balsa max-w-[720px] mb-[28px] text-white">
